...
public class ReplayPacketListener extends AbstractListener {
	...
	public void register() {
		this.packetAdapter = new PacketAdapter(AdvancedFastBuilderPlugin.getInstance(), ListenerPriority.NORMAL, PacketType.Play.Client.USE_ENTITY, PacketType.Play.Server.ENTITY_DESTROY) {
